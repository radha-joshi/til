...
# > All heading elements
  ...
  The h1 through h6 heading elements are used to signify the importance of content below them. The lower the number, the higher the importance, so h2 elemeeeents have less importance than h1 elements.
